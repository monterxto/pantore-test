...
describe('Users Module', () => {
  ...
  describe('Update', () => {
    let newUser;
    const newUserEmail = `user-pantore.${Date.now()}@pantore.com`;
    const newUserChangedEmail = `user-pantore-changed.${Date.now()}@pantore.com`;
  ...
  describe('Create', () => {
    const newUserByAdminEmail = `user-created-by-admin.${Date.now()}@pantore.com`;
